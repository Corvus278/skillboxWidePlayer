class Player {
  ...
  constructor() {
    ...
    this.#playerWrapperElem = document.querySelector(this.classes.playerWrapper)
    this.#prevBtnContElem = document.querySelector(`.${this.classes.prevLessonCont}`)
    this.#nextBtnContElem = document.querySelector(`.${this.classes.nextLessonCont}`)
    this.#subtitleControlsElem = document.querySelector(`.${this.classes.subtitleControls}`)
  }
  ...
  get #player() {
    return this.#playerElem ? this.#playerElem : document.querySelector(this.classes.player)
  }

  get #playerWrapper() {
    return this.#playerWrapperElem ? this.#playerWrapperElem : document.querySelector(this.classes.playerWrapper)
  }

  get #prevBtnCont() {
    return this.#prevBtnContElem ? this.#prevBtnContElem : document.querySelector(this.classes.prevLessonCont)
  }

  get #nextBtnCont() {
    return this.#nextBtnContElem ? this.#nextBtnContElem : document.querySelector(this.classes.nextLessonCont)
  }

  get #subtitleControls() {
    return Array.from((this.#subtitleControlsElem ? this.#subtitleControlsElem : document.querySelector(this.classes.subtitleControls)).children)
  }
  ...
  toLargeWidth() {
    ...
    this.#subtitleControls.forEach(control => control.classList.remove(this.classes.hideDesktop))
  ...
  toNormalWidth() {
    ...
    this.#subtitleControls.forEach(control => control.classList.add(this.classes.hideDesktop))
